...
const ceramicPostPage = observer(() => {
      ...
      {postStore.post && (
        <div className="max-w-[100rem] w-full mx-auto mt-10">
          <div className="flex flex-col justify-between gap-10 border-[1px] border-forma_ro_grey rounded-2xl p-8 relative">
            ...
            <p className="absolute top-0 right-0 p-8 text-[15px]">Keramik inlägg</p>
          ...
          <div className="mt-10 text-white bg-forma_ro_brown p-2">
            <h3>Andra inlägg</h3>
          </div>
        </div>
      )}
...
export default ceramicPostPage