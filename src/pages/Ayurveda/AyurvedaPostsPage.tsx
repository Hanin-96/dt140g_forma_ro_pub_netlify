...
const AyurvedaPostsPage = observer(() => {
        ...
        <>
            ...
            {!postStore.loading && !postStore.error && (
                <div className="mx-auto max-w-[100rem]">
                    <h1 className="mt-20 mb-16 text-center">Ayurveda inlägg</h1>
                    ...
                    <div className="p-2 flex flex-wrap gap-8">
                        {postStore.posts.map(post => (
                            <Link key={post.id} to={`/ayurveda-inlagg/${post.id}`} className="hover:no-underline max-w-[100rem] w-full">
                                <article className="border-[1px] border-forma_ro_grey rounded-3xl hover:bg-forma_ro_orange">
