...
class ProductStore {
    ...
    async getCeramicProducts(productId = "") {
        ...
        try {
            const response = await fetch(
                "https://studenter.miun.se/~hafa2300/writeable/dt140g/forma_ro_demo/wordpress/wp-json/wp/v2/product?_fields=title,product_price,product_description,product_thumbnail,product_thumbnail_alt,id,date,product_category",
                {
                    method: "GET",
                    headers: {
    ...
    async getProductById(productId: string) {
        ...
        try {
            const response = await fetch(`https://studenter.miun.se/~hafa2300/writeable/dt140g/forma_ro_demo/wordpress/wp-json/wp/v2/product/${productId}`);
